...
Your specification should be self-contained and describe all behaviour that is implemented by it before being submitted to this repo. If it is not, it may be sent it back to the [IRCv3/ideas](https://github.com/ircv3/ideas) repository to be workshopped until it is able to be fully specified.
